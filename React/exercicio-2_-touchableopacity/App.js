...
const ShowList = ({ id, title, clickCount, handleCardPress }) => {
  return (
    <TouchableOpacity
      style={styles.button}
...
const ShowList2 = ({ id, title, clickCount, handleCardPress1 }) => {
  return (
    <TouchableOpacity
      style={styles.button}
...
const Flat = ({ filterList, sortList, getFilteredData, handleCardPress }) => {
  return (
    <View>
      <FlatList
