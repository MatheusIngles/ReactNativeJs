    ...
    return (
        <View style={styles.flatlistView}>
          <FlatList
            ...
            renderItem={({item}) => <ItemLista nome={item.nome} desc={item.desc} uri={item.img} preco={item.preco} onPress={onPress} />}
...
const ItemLista = ({ nome, desc, uri, preco, onPress }) => {
    ...
    <Card>
        ...
        <View style={styles.itemAddCartsButtonView}>
          <TouchableOpacity
            ...
            onPress={() => onPress(nome, uri, preco)}
          >
...
export default function Items({ navigation }) {
  ...
  const navFunction = (nome, img, preco) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <ItensComp 
        itens={produtos}
        onPress={(nome, img, preco) => {navFunction(nome, img, preco)}}
