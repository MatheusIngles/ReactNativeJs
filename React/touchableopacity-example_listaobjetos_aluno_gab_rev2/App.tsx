...
// https://snack.expo.dev/@saullo/touchableopacity-example_listaobjetos_aluno_gab

//https://snack.expo.dev/@saullo/touchableopacity-example_listaobjetos_aluno_gab_rev2
...
const App = () => {
  ...
  const [selectedFilter, setSelectedFilter] = useState('') // estado para usar no picker
  ...
  //funcao para filtrar a lista usando Picker
    ...
    <View style={styles.container}>
      ...
      */}
      ...
      <RNPickerSelect
        ...
        placeholder={{label: "Selecione um elemento para filtar", value:''}}
        items={
          [
